package com.youcode.weather__app;
...
public class MainActivity extends AppCompatActivity {
    private static final String API_KEY = "a65971396c19799163a823cda5465b83";
    ...
    private void loadWeatherByCityName(String city) {
        ...
        Ion.with(this)
               /* .load("http://api.openweathermap.org/data/2.5/weather?q="+city+"&appid="+API_KEY)*/
                .load("http://api.openweathermap.org/data/2.5/weather?q="+city+ "&appid=51f48ad09605b913b419643bca7336c5")
                    .asJsonObject()
                        .setCallback((e, result) -> {
                            ...
                            if(e != null) {
                                ...
                                //convert jsonresponse to java
                                JsonObject main = result.get("main").getAsJsonObject();
                                double temp = main.get("temp").getAsDouble();
                                double tempEnCeli=temp-273.15;
                                tvTemp.setText(new DecimalFormat("##.##").format(tempEnCeli));

                                //gtvTemp.setText(tempEnCeli+"°C");
                                ...
                                // get coordination city for get daily api
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        if (e != null) {
                            ...
                            //parse jsonString  to java string
